...
const getDom = () => {
  const currentElements = {
    ...
    deleteCity: Array.from(document.querySelectorAll('.deleteCity')),
    addCity: Array.from(document.querySelectorAll('.addCity')),
    ...
    placeText: Array.from(document.querySelectorAll('.placeText')),
    noCitySection: document.querySelector('.noCitySection'),
    citySectionTitle: document.querySelector('.citySectionTitle'),
    citySectionDescription: document.querySelector('.citySectionDescription'),
    ...
    hourlyForecastHolder: document.querySelector('.hourlyForcastHolder'),
    weeklyForecastHolder: document.querySelector('.weeklyForcastHolder'),
    weatherInfoHolder: document.querySelector('.weatherInfoHolder'),
    wordHolder: document.querySelector('.wordHolder'),
